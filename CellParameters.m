% The parameters (user-defined) for the moving cell through ECM simulations
% Fluid parameters
...
kf=0;                % stiffness of the elastic ECM fibers
gamf=0;             % surface tension of the elastic ECM fibers
rfib=0;             % radius of the ECM fibers
fibspace=0.5*rc;    % minimum spacing of the fiber centers (need 2*rfib so they don't overlap)
numfibers=20;       % number of fibers in the ECM
...
ecmfile='ecm20.mat';% file name of the existing ECM
